...
function getEmployeeApproved(){

    fetch(
        'http://localhost:9001/Project1/ajax/fmresolved')   
...
function ourDOMManipulation(ourJSON) {
	...
	for (let i = 0; i < ourJSON.length; i++) {
        ...
        let myText9 = document.createTextNode(approvedDate.toLocaleDateString());
		...
		let newSelectionTwo = document.querySelector("#resolvedTableBody");
